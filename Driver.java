public class Driver {
  ...
  public static void main(String[] args) {
    ...
    SuperArray SU = new SuperArray(1);
    System.out.println("should return superarray with 2 nulls: " + SU.toStringDebug());
    SU.add("and so we say");
    SU.add("adieu");
    SU.add("to you");
    SU.add("and you and you and you");
    System.out.println("should return superarray with added values: " + SU.toStringDebug());
